...
<h1><p style="color: blue;">HAMI - 聯合診所掛號系統 - 看診完成</p></h1>
<ul>
  <li><a href="index.php">Home</a></li>
  <li><a href="entry.php">病患資料</a></li>
  <li><a href="register.php">掛號登錄</a></li>
  <li><a class="active" href="update_register.php">看診完成</a></li>
...
$sql = " SELECT *
        ...
        ON registration.dept_id = department.department_id
        WHERE status = '0';  ";
...
echo "<td>
      ...
      <button type='submit' name='regis_id' value='" . $row['id'] . "' class='btn-link'>完成診療</button>
      </form></td>"; 
